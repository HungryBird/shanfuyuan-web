...
const methodsToken = [
	...
	'water.getCate',
	'water.waterDetail',
	'water.checkUserPoint',
	'waterorder.create',
	'waterorder.details',
	'user.waterPay'	,
	'waterorder.getorderlist',
	'waterorder.cancel',
	'waterorder.confirm',
	'waterorder.take',
	'waterorder.taking',
	'waterorder.aftersalesstatus',
	'water.goodsPackage',
	
	//水店管理端
	'watermanage.waterManageStatus',
	'watermanage.saveApply',
	'watermanage.shopInfo',
	'watermanage.shopEdit',
	'watermanage.changeShopStatus',
	'watermanage.changeShopAutoStatus',
	'watermanage.addGoods',
	'watermanage.editGoods',
	'watermanage.allGoodsList',
	'watermanage.changeGoodsStatus',
	'watermanage.goodsInfo',
	'watermanage.allGoodsPackageList',
	'watermanage.changeGoodsPackageStatus',
	'watermanage.addGoodsPackage',
	'watermanage.editGoodsPackage',
	'watermanage.goodsPackageInfo',
	'watermanage.shopStatistic',
...
const post = (method, data, callback) => {
	...
	if (methodsToken.indexOf(method) >= 0) {
		...
		if (!userToken) {
			...
			// 	method: 'POST',
			// 	success(response) {
			// 		let url = response.data.data.Wxofficial
...
// 订单售后状态
export const afterSalesStatus2 = (data, callback) => post('waterorder.aftersalesstatus', data, callback);
...
// 支付接口
export const waterPay = (data, callback) => post('user.waterPay', data, callback);
...
//送水分类
export const getWaterCate = (data, callback) => post('water.getCate', data, callback);
//解析经纬度
export const getAddress = (data, callback) => post('water.getAddress', data, callback);
//水店列表
export const getWaterShopList = (data, callback) => post('water.shopList', data, callback);
//水店详情
export const getWaterShopDetail = (data, callback) => post('water.shopDetail', data, callback);
//水店商品详情
export const getWaterGoodsDetail = (data, callback) => post('water.waterDetail', data, callback);
//积分抵扣按钮
export const checkUserPoint = (data, callback) => post('water.checkUserPoint', data, callback);
//关注
export const waterCollect = (data, callback) => post('water.waterCollect', data, callback);
//水票详情
export const waterPackageDetail = (data, callback) => post('water.goodsPackage', data, callback);
// 生成订单
export const createWaterOrder = (data, callback) => post('waterorder.create', data, callback);
// 获取订单详情
export const waterOrderDetail = (data, callback) => post('waterorder.details', data, callback);
// 获取状态订单列表
export const waterOrderList = (data, callback) => post('waterorder.getorderlist', data, callback);
// 取消订单
export const cancelWaterOrder = (data, callback) => post('waterorder.cancel', data, callback);
// 接单
export const takeOrder = (data, callback) => post('waterorder.take', data, callback);
// 配送
export const takingOrder = (data, callback) => post('waterorder.taking', data, callback);



// 确认收货
export const confirmWaterOrder = (data, callback) => post('waterorder.confirm', data, callback);



// 检测申请水店状态
export const waterManageStatus = (data, callback) => post('watermanage.waterManageStatus', data, callback);
// 申请开店
export const saveApply = (data, callback) => post('watermanage.saveApply', data, callback);
// 水店详情
export const shopInfo = (data, callback) => post('watermanage.shopInfo', data, callback);
// 水店详情
export const shopEdit = (data, callback) => post('watermanage.shopEdit', data, callback);



// 修改水店状态
export const changeShopStatus = (data, callback) => post('watermanage.changeShopStatus', data, callback);
export const changeShopAutoStatus = (data, callback) => post('watermanage.changeShopAutoStatus', data, callback);

// 添加水店商品
export const addWaterGoods = (data, callback) => post('watermanage.addGoods', data, callback);
// 修改水店商品
export const editWaterGoods = (data, callback) => post('watermanage.editGoods', data, callback);
// 添加水店商品水票
export const addWaterGoodsPackage = (data, callback) => post('watermanage.addGoodsPackage', data, callback);
// 修改水店商品水票
export const editWaterGoodsPackage = (data, callback) => post('watermanage.editGoodsPackage', data, callback);
// 水店商品列表
export const goodsIndex = (data, callback) => post('watermanage.allGoodsList', data, callback);
// 修改锈点商品状态
export const changeWaterGoodsStatus = (data, callback) => post('watermanage.changeGoodsStatus', data, callback);
// 修改水店商品水票状态
export const changeWaterGoodsPackageStatus = (data, callback) => post('watermanage.changeGoodsPackageStatus', data, callback);
// 商品详情
export const waterGoodsInfo = (data, callback) => post('watermanage.goodsInfo', data, callback);
// 水票详情
export const waterGoodsPackageInfo = (data, callback) => post('watermanage.goodsPackageInfo', data, callback);
// 水店水票列表
export const goodsPackageIndex = (data, callback) => post('watermanage.allGoodsPackageList', data, callback);
// 水店水票列表
export const shopStatistic = (data, callback) => post('watermanage.shopStatistic', data, callback);