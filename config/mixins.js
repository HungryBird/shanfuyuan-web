export const orders = {
	...
	methods: {
		...
		// 查看订单详情
		waterOrderDetail(orderId) {
			this.$common.navigateTo(
				'/pages/member/order/waterorderdetail?order_id=' + orderId
			)
		},
		// 查看订单详情
		waterOrderDetail2(orderId) {
			this.$common.navigateTo(
				'/pages/waterManage/waterorderdetail?order_id=' + orderId
			)
		},
		...
		toPay(orderId) {
			this.$common.navigateTo(
				'/pages/goods/payment/index?order_id=' + orderId + '&type=1&from=1'
			)
		},
		// 去支付
		toPay2(orderId) {
			this.$common.navigateTo(
				'/pages/goods/payment/index?order_id=' + orderId + '&type=1&from=2'
			)
		},
		...
		toEvaluate(orderId) {
			this.$common.navigateTo(
				'/pages/member/order/evaluate?order_id=' + orderId+'&from=1'
			)
		},
		
		// 去评价
		toWaterEvaluate(orderId) {
			this.$common.navigateTo(
				'/pages/member/order/evaluate?order_id=' + orderId+'&from=2'
			)
		},
		// 申请售后
...
export const goods = {
	...
	methods: {
		...
		// 查看商品详情
		waterGoodsDetail(goodsId) {
			this.$common.navigateTo('/pages/water/detail?id=' + goodsId)
		},
		waterPackageDetail(goodsId){
			this.$common.navigateTo('/pages/water/ticket?id=' + goodsId)
		},
